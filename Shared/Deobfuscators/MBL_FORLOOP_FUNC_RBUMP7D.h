...
static void MBL_FORLOOP_FUNC_RBUMP7D(char *cString, int iNumOfChars, char cXorKey)
{
...
static void MBL_FORLOOP_FUNC_RBUMP7D(wchar_t *wcString, int iNumOfChars, wchar_t wcXorKey)
{
