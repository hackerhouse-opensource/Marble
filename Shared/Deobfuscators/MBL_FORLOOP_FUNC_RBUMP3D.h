...
static void MBL_FORLOOP_FUNC_RBUMP3D(char *cString, int iNumOfChars, char cXorKey)
{
...
static void MBL_FORLOOP_FUNC_RBUMP3D(wchar_t *wcString, int iNumOfChars, wchar_t wcXorKey)
{
