...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_BUMP6.h"


MBL_CLASS_BUMP6::MBL_CLASS_BUMP6(void)
{
	srand(time(NULL));
...
int MBL_CLASS_BUMP6::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP6::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP6::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_CLASS_BUMP6D m%sMarbleXorClass;\r\n"
...
int MBL_CLASS_BUMP6::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
