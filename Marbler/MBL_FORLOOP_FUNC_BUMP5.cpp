...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_FUNC_BUMP5.h"

MBL_FORLOOP_FUNC_BUMP5::MBL_FORLOOP_FUNC_BUMP5(void)
{
...
int MBL_FORLOOP_FUNC_BUMP5::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_BUMP5::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_BUMP5::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		...
		"MBL_FORLOOP_FUNC_BUMP5D(%s, %d, c%sMarbleBumpKey);\r\n";
...
int MBL_FORLOOP_FUNC_BUMP5::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
	...
	char cInsertFormat[] = "wchar_t %s[] = %s;\r\n"
		...
		"MBL_FORLOOP_FUNC_BUMP5D(%s, %d, wc%sMarbleBumpKey);\r\n";
