...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_BUMP10.h"

MBL_FORLOOP_BUMP10::MBL_FORLOOP_BUMP10(void)
{
	cKeyLiteral = NULL;
	cWKeyLiteral = NULL;
...
int MBL_FORLOOP_BUMP10::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_BUMP10::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_BUMP10::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
...
int MBL_FORLOOP_BUMP10::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
