...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_RBUMP6.h"

MBL_FORLOOP_RBUMP6::MBL_FORLOOP_RBUMP6(void)
{
	srand(time(NULL));
...
int MBL_FORLOOP_RBUMP6::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP6::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP6::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
...
int MBL_FORLOOP_RBUMP6::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
