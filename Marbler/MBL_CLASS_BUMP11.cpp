...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_BUMP11.h"


MBL_CLASS_BUMP11::MBL_CLASS_BUMP11(void)
{
	cKeyLiteral = NULL;
	cWKeyLiteral = NULL;
...
int MBL_CLASS_BUMP11::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP11::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP11::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		...
		"MBL_CLASS_BUMP11D m%sMarbleXorClass(c%sMarbleXorKey, %s, %d);\r\n";
...
int MBL_CLASS_BUMP11::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
