...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_RBUMP3.h"

MBL_FORLOOP_RBUMP3::MBL_FORLOOP_RBUMP3(void)
{
	srand(time(NULL));
...
int MBL_FORLOOP_RBUMP3::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP3::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP3::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
...
int MBL_FORLOOP_RBUMP3::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
