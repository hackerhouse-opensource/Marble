...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_BUMP9.h"


MBL_CLASS_BUMP9::MBL_CLASS_BUMP9(void)
{
	cKeyLiteral = NULL;
	cWKeyLiteral = NULL;
...
int MBL_CLASS_BUMP9::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP9::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP9::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		...
		"MBL_CLASS_BUMP9D m%sMarbleXorClass(c%sMarbleXorKey, %s, %d);\r\n";
...
int MBL_CLASS_BUMP9::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
