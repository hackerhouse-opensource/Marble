...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_RBUMP8.h"

MBL_FORLOOP_RBUMP8::MBL_FORLOOP_RBUMP8(void)
{
	srand(time(NULL));
...
int MBL_FORLOOP_RBUMP8::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP8::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP8::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
...
int MBL_FORLOOP_RBUMP8::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
