...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_RBUMP1.h"

MBL_FORLOOP_RBUMP1::MBL_FORLOOP_RBUMP1(void)
{
	srand(time(NULL));
...
int MBL_FORLOOP_RBUMP1::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP1::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP1::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
...
int MBL_FORLOOP_RBUMP1::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
