...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_RBUMP12.h"


MBL_CLASS_RBUMP12::MBL_CLASS_RBUMP12(void)
{
	srand(time(NULL));
...
int MBL_CLASS_RBUMP12::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_RBUMP12::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_RBUMP12::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_CLASS_RBUMP12D m%sMarbleXorClass(%s, %d, 0x%02X);\r\n";
...
int MBL_CLASS_RBUMP12::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
	...
	char cInsertFormat[] = "wchar_t %s[] = %s;\r\n"
		"MBL_CLASS_RBUMP12D m%sMarbleXorClass(%s, %d, 0x%04X);\r\n";
