...
MBL_FORLOOP_FUNC_XOR2::MBL_FORLOOP_FUNC_XOR2(void)
{
	srand(time(NULL));
...
int MBL_FORLOOP_FUNC_XOR2::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_XOR2::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_XOR2::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_FORLOOP_FUNC_XOR2D(%s, %d, 0x%02X);\r\n";
...
int MBL_FORLOOP_FUNC_XOR2::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
	...
	char cInsertFormat[] = "wchar_t %s[] = %s;\r\n"
		"MBL_FORLOOP_FUNC_XOR2D(%s, %d, 0x%04X);\r\n";
