...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_RXOR11.h"


MBL_CLASS_RXOR11::MBL_CLASS_RXOR11(void)
{
	srand(time(NULL));
...
int MBL_CLASS_RXOR11::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_RXOR11::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_RXOR11::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_CLASS_RXOR11D m%sMarbleXorClass(0x%02X, %s, %d);\r\n";
...
int MBL_CLASS_RXOR11::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
	...
	char cInsertFormat[] = "wchar_t %s[] = %s;\r\n"
		"MBL_CLASS_RXOR11D m%sMarbleXorClass(0x%04X, %s, %d);\r\n";
