...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_RBUMP2.h"

MBL_FORLOOP_RBUMP2::MBL_FORLOOP_RBUMP2(void)
{
	srand(time(NULL));
...
int MBL_FORLOOP_RBUMP2::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP2::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_RBUMP2::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
...
int MBL_FORLOOP_RBUMP2::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
