...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_RBUMP3.h"


MBL_CLASS_RBUMP3::MBL_CLASS_RBUMP3(void)
{
	srand(time(NULL));
...
int MBL_CLASS_RBUMP3::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_RBUMP3::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_RBUMP3::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_CLASS_RBUMP3D m%sMarbleXorClass(0x%02X, %d, %s);\r\n";
...
int MBL_CLASS_RBUMP3::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
	...
	char cInsertFormat[] = "wchar_t %s[] = %s;\r\n"
		"MBL_CLASS_RBUMP3D m%sMarbleXorClass(0x%04X, %d, %s);\r\n";
