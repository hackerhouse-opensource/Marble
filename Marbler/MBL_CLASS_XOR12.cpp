...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_XOR12.h"


MBL_CLASS_XOR12::MBL_CLASS_XOR12(void)
{
	cKeyLiteral = NULL;
	cWKeyLiteral = NULL;
...
int MBL_CLASS_XOR12::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_XOR12::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_XOR12::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"char c%sMarbleKey[] = %s;\r\n"
		"MBL_CLASS_XOR12D m%sMarbleXorClass(%s, %d, c%sMarbleKey);\r\n";
...
int MBL_CLASS_XOR12::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
