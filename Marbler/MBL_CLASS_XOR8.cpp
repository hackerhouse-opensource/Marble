...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_XOR8.h"


MBL_CLASS_XOR8::MBL_CLASS_XOR8(void)
{
	srand(time(NULL));
...
int MBL_CLASS_XOR8::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_XOR8::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_XOR8::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_CLASS_XOR8D m%sMarbleXorClass;\r\n"
...
int MBL_CLASS_XOR8::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
