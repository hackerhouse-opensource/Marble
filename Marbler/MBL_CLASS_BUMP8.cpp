...
#include <stdlib.h>
#include <time.h>
#include "MBL_CLASS_BUMP8.h"


MBL_CLASS_BUMP8::MBL_CLASS_BUMP8(void)
{
	srand(time(NULL));
...
int MBL_CLASS_BUMP8::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP8::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_CLASS_BUMP8::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		"MBL_CLASS_BUMP8D m%sMarbleXorClass;\r\n"
...
int MBL_CLASS_BUMP8::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
