...
MBL_FORLOOP_FUNC_XOR5::MBL_FORLOOP_FUNC_XOR5(void)
{
	cKeyLiteral = NULL;
	cWKeyLiteral = NULL;
...
int MBL_FORLOOP_FUNC_XOR5::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_XOR5::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_XOR5::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char c%sMarbleXorKey[] = %s;\r\n"
		"char %s[] = %s;\r\n"
		"MBL_FORLOOP_FUNC_XOR5D(%s, %d, c%sMarbleXorKey);\r\n";
...
int MBL_FORLOOP_FUNC_XOR5::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
