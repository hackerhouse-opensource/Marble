...
#include <stdlib.h>
#include <time.h>
#include "MBL_FORLOOP_FUNC_BUMP11.h"

MBL_FORLOOP_FUNC_BUMP11::MBL_FORLOOP_FUNC_BUMP11(void)
{
	cKeyLiteral = NULL;
	cWKeyLiteral = NULL;
...
int MBL_FORLOOP_FUNC_BUMP11::ScrambleW(wchar_t *wcToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_BUMP11::ScrambleA(char *cToScramble, unsigned int iNumOfChars)
{
...
int MBL_FORLOOP_FUNC_BUMP11::GenerateInsertA(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	...
	char cInsertFormat[] = "char %s[] = %s;\r\n"
		...
		"MBL_FORLOOP_FUNC_BUMP11D(%s, %d, c%sMarbleBumpKey);\r\n";
...
int MBL_FORLOOP_FUNC_BUMP11::GenerateInsertW(char *cVarName, char *cStringLiteral, unsigned int iNumOfChars, char *&cInsert)
{
	if (cVarName == NULL || cStringLiteral == NULL)
		return 0;
	cInsert = NULL;
	...
	char cInsertFormat[] = "wchar_t %s[] = %s;\r\n"
		...
		"MBL_FORLOOP_FUNC_BUMP11D(%s, %d, wc%sMarbleBumpKey);\r\n";
